...
// // constructor function syntax
// class personA {
//   constructor(name, age, human, candance) {
//     this.name = name;
//     this.age = age;
//     this.human = true;
//     this.canDance = () => {
...
// let Brandon = new PersonA("Brandon", 45);

// let Bill = new PersonA("Bill", 25);
...
//   }
// };
// console.log(Bill.canDance());


//// rays answer for inspiration - he used very few lines to achieve a readable result. Enjoy the simplicity but feel something is missing /////
